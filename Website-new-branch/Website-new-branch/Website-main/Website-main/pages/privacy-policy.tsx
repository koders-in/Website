  ...
  <div className="bg-main-primary overflow-hidden relative">
    ...
    <div className="pb-10 pt-28 w-[95%] sm:w-[90%] mx-auto">
      ...
      >
        ...
        and respecting the privacy of our customers or anyone who might
        associate with us while delivering our products and services. This
        policy explains how we collect, use, and share data that we may obtain
        through our website and our software development services.
        <ul className="list-decimal ml-5 sm:ml-0">
          ...
          <li className="font-miligramLight my-6 text-[1.05rem] text-main-white-700 w-[96%] mx-auto text-justify">
            Your rights: You have the right to access, rectify, erase, restrict,
            or object to the processing of your personal information. You also
            have the right to withdraw your consent or to exercise your right to
            data portability. If you have any concerns about how we handle your
            personal information, you can contact us at
            <span
              onClick={() => window.open(`mailto:support@koders.in"?`, "_bank")}
