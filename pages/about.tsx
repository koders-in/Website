    ...
    <ErrorBoundary>
      <div className="font-miligrambold bg-main-primary pt-28 relative overflow-hidden">
        ...
        <div className="w-[90%] mx-auto">
          <div className="md:h-[80vh] xxl:h-auto">
            ...
            <div className="text-center text-[1.25em] text-main-light_white  w-[100%] sm:w-[75%] md:w-[60%] lg:w-[70%] mx-auto leading-none font-miligramTextMedium font-medium">
              We are committed to building software solutions that are
              innovative and unparalleled in quality. We believe that by
              leveraging the full potential of our team, we can create software
              products that truly stand out in the market. At Koders, we are
              always striving to build software with new dimensions that truly
          ...
          >
            We believe in fostering a positive and collaborative work
            environment where our team members can grow and develop their
            skills. We offer opportunities for learning and professional
            development, as well as a supportive and inclusive culture where
        ...
        <p className="text-center font-miligramTextBookItalic font-light text-main-light_white text-[0.8em] sm:text-[1.2rem] py-2">
          ...
          >
            Since our launch in 2018, Koders has had the pleasure of working
