          ...
          <div className="left">
            <Fade left>
              ...
              <p>
                ...
                We create a modern platform that enables millions to build a
                brand, share their stories, and transact with their customers in
          ...
          <div className="right">
            <div className="counts">
              <Fade right>
                <h3>HAPPY CLIENTS</h3>
                <h1>
                  <CountUp end={147} duration={5.0} />
                </h1>
                <h3>PROJECTS COMPLETED</h3>
                <h1>
                  <CountUp end={170} duration={5.0} />
                </h1>
                <h3>CUPS OF COFFEE</h3>
                <h1>
                  <CountUp end={121} separator="," decimal="," duration={5.0} />
                </h1>
              </Fade>
            </div>
          </div>
